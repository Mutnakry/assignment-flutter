import 'package:assingment_flutter/component/signup.dart';
import 'package:assingment_flutter/screen/app_dashboard.dart';
          ...
          child: Form(
            ...
            child: ListView(
              children: <Widget>[
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=>AppDashboard(),
                    ),
                        (route)=>false,
                    );
                  },
